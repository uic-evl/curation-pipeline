...
if __name__ == "__main__":
    ...
    input_path = join(folder_init, 'sample_data_for_Juan')
    output_path = join(folder_init, 'output')
    chrome_driver_path = join(folder_init, 'chromedriver_win32','chromedriver.exe')
    xpdf_path = join(output_path, 'pdf_output')  
